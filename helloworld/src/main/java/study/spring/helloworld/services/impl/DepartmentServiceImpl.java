...
public class DepartmentServiceImpl implements DepartmentService{
    ...
    @Override
    public DepartmentModel insert(DepartmentModel input) throws NullPointerException, Exception {
        // insert문 수행
        // 리턴되는 값은 저장된 데이터의 수
    ...
    @Override
    public DepartmentModel update(DepartmentModel input) throws NullPointerException, Exception {
    ...
    @Override
    public void delete(DepartmentModel input) throws NullPointerException, Exception {
    ...
    @Override
    public DepartmentModel selectItem(DepartmentModel input) throws NullPointerException, Exception {
        DepartmentModel output = departmentMapper.selectItem(input);
    ...
    @Override
    public List<DepartmentModel> selectList(DepartmentModel input) throws NullPointerException, Exception {
        return departmentMapper.selectList(input);
    }

    @Override
    public int selectCount(DepartmentModel input) throws NullPointerException, Exception {
